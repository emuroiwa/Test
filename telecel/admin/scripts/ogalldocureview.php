...
while($row = mysql_fetch_array($rs)){
	 ...
	 echo "<tr><td>".$name."</td><td>".$surname."</td><td><a href='index.php?page=viewdocu.php&id=$row[did]' onclick='return confirm(\"Are you sure you ?\")'>[click to view]</a></font></td><td><a href='index.php?page=sendqo.php&id=$row[did]&user=$row[user]' onclick='return confirm(\"Are you sure you ?\")'>[$xxx]</a></font></td>$td2</tr>";
