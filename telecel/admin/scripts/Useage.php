...
if ($result )
{
 ...
 echo "<font color='red'><h3>Intial Level Where $oldlevel , Useage was $topup , New Level is $newlevel </h3></font>";
         }
       else
        {
            $msg= "Error Occured";
...
<table width="100%" border="0" align="center" style="border-bottom:3px solid #000000;" class="table table-bordered table-hover">
      ...
      <tr>
        <td><div align="center"><span class="style7">Useage Site
        </span></div></td>
...
<tr>
  <td width="27%"> <span class="style1 style9">Useage </span></td>
  <td width="73%">
