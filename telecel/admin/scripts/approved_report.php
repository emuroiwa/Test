...
<div align="center">
	<div class="main_div">
		<div class="main">
			<div class="main_site">
			  <div class="header">Report Of Documents Being Approved By The Quality Officer<br />
...
{
	  $result ="";
	 $result = mysql_query("select * from document where level='Approved'  AND doctime  BETWEEN '$date' AND '$date1' order by doctime desc  ")or die(mysql_query());
