...
<?php
 ...
 location = 'index.php?page=registration.php'
  ...
  exit;
	   ...
	   $number=$_POST['country'].$_POST['contact'];
 $rs = mysql_query("insert into users(name,surname,sex,email,username,password,idnumber,date,access) values ('$_POST[name]','$_POST[surname]','$_POST[sex]','$_POST[email]','$_POST[username]','$_POST[password]','$number','$date','$_POST[access]')") or die(mysql_error()."dbgfd");
 /*$res = mysql_query("insert into audit_tray(id,username,operation,date) values('NULL','1','Added new user $name $surname','$date')") or die(mysql_error());*/
      ...
      <td>
        <input name="name" type="text" id="name" onkeypress="return lettersOnly(event)" />       </td>
          ...
          <tr>
            ...
            <tr><td>Cellphone*</td><td><select name="country" id="" required>
...
<option data-countryCode="ZW" value="263">Zimbabwe (+263)</option>
...
</select><input name="contact" type="number" id="contact" min="700000000" max="790000000" placeholder="eg 774002797"></td></tr>  
    ...
    <tr>
      <td>User Name</td>
      <td>
        <input name="username" type="text" id="username" required   />             </td>
      </tr>
          <tr>
            ...
            <br />
          Password Should Be atleast 8 characters</span><span class="textfieldMinCharsMsg">.</span></span></td>
    </tr>
          <tr>
            <td>Confirm </td>
            <td>
              <input name="cpass" type="password" id="cpass" required />            </td></tr>
               <tr>
            <td>Access Level</td>
            <td> <select name="access" required><option value="2">Staff</option>   <option value="3">Manager</option><option value="1">Admin</option></select> </td>
</tr>
         		  <tr>
            <td></td>
            <td>
