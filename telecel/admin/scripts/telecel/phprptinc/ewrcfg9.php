...
define("EWR_PROJECT_ID", "{071D0047-16DB-46CE-AE84-63B7E07DBB14}", TRUE); // Project ID
define("EWR_PROJECT_NAME", "telecel", TRUE); // Project Name
...
$EWR_CONN["DB"] = array("conn" => NULL, "id" => "DB", "type" => "MYSQL", "host" => "localhost", "port" => 3306, "user" => "root", "pass" => "", "db" => "telecel", "qs" => "`", "qe" => "`");
...
define("EWR_RANDOM_KEY", 'fLE4RkTySLV21OUk', TRUE); // Random key for encryption
define("EWR_PROJECT_STYLESHEET_FILENAME", "phprptcss/telecel.css", TRUE); // Project stylesheet file name
