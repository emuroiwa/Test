...
$granularity = 2;
$from_text =GetText1($_GET['id']);
$to_text =GetReviewText($_GET['id']);
$diff_opcodes = '';
$diff_opcodes_len = 0;
$data_key = '';
...
<form action="index.php?page=diff/viewdiff.php" method="post">
<p style="margin:1em 0 0.5em 0">Enter text to diff below:</p>
<div class="panecontainer" style="display:inline-block;width:49.5%"><p>From</p><div><textarea name="from" class="pane" readonly><?php echo htmlentities($from_text, ENT_QUOTES, 'UTF-8'); ?></textarea></div></div>
<div class="panecontainer" style="display:inline-block;width:49.5%"><p>To</p><div><textarea name="to" class="pane" readonly><?php echo htmlentities($to_text, ENT_QUOTES, 'UTF-8'); ?></textarea></div></div>
