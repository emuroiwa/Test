															...
															<table border="0" cellpadding="30" cellspacing="0" width="100%">
																<tr>
																	<td align="center" valign="top" class="textContent">
																		<h1 style="color:#FFFFFF;line-height:100%;font-family:Helvetica,Arial,sans-serif;font-size:35px;font-weight:normal;margin-bottom:5px;text-align:center;">Telecel Password Reset</h1>
...
Please Login To Telecel using your new password.
<br>
...
$mail->Username = "Telecelsystem@gmail.com";
$mail->Password = "password1*";
$mail->Subject = "Telecel User Password Reset";
$mail->Body = $body1;
